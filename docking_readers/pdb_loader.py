...
def extract_pdb_poses(poses_data, reference_structure, ligand_residue_name='LIG', verbosity=0, **kwargs):
    """
    ...
    for ligand_name, ligand_dict in poses_data.items():
        ...
        try:
            ...
            for each_res in pybel.ob.OBResidueIter(this_pdb_data.OBMol):
                ...
                os_util.local_print('Could not find ligand molecule {} in file {}\nI have read the following '
                                    'residues: {}\n'
                                    ''.format(ligand_name, ligand_dict,
